...
class Actions:
    ...
    # This is becuase order matters when running alpha-beta pruning.
    # It's a bit of a hack, but otherwise would need to re-code all the variants
    #  of common mistakes that the test offers
    ...
    _directions_as_list = sorted(_directions.items(), key=_sort) 
